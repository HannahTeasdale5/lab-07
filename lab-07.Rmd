...
Ex1.1 The data is left skewed,the mean is to the left of the median. 
...
ggplot(data = evals, 
  ...
  labs(
    ...
    y = "Score",
    title = "Relationship Between Score and Average Beauty Rating of Professor",
...
Ex1.2 geom_jitter() seems to be less rounded than geom_point(). Maybe some of the points were seeming to be missing with geom_point() as they would be on top of each other. With geom_jitter() it seems to be that points that have multiple points in the same place would appear larger.
